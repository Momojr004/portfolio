...
const Home: React.FC = () => {
  ...
  return (
    <>
      <SEO
        title="Mouhamed Pouye — Développeur Full-Stack & Entrepreneur Tech | Dakar, Sénégal"
        description="Développeur Full-Stack & co-fondateur TerangaDev. Spécialisé React, Laravel, Flutter, Node.js. Digitalisation des PME africaines & solutions santé numérique. Basé à Dakar."
        keywords="développeur full-stack dakar, react developer sénégal, terangadev, ecomed24, freelance développeur afrique, digitalisation pme, laravel, flutter, node.js, mouhamed pouye"
      />
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
