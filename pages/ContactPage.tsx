...
const TiltCard = ({ children, isDark }: { children: React.ReactNode, isDark: boolean }) => {
  ...
  return (
    <motion.div
      ...
      className={`p-8 md:p-12 rounded-[3rem] border-2 transition-colors relative ${
        isDark ? 'bg-zinc-900/40 border-zinc-800/50' : 'bg-white border-zinc-100'
      }`}
    >
          ...
          <div>
            ...
            >
              ...
              <div className="space-y-4">
                <a href="mailto:hello@momo.tech" className="group flex items-center gap-4 text-2xl md:text-3xl font-black hover:text-[#CCFF00] transition-colors">
                  hello@momo.tech
            ...
            <div>
              ...
              <div className="flex flex-col gap-1">
                {['LinkedIn', 'Twitter', 'GitHub'].map(s => (
                  <a key={s} href="#" className="font-bold hover:text-[#CCFF00] transition-colors">{s}</a>
                ))}
              </div>
            </div>
          </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                <div className="space-y-2">
                  ...
                  <input 
                    ...
                    className={`w-full bg-transparent border-b-2 py-4 outline-none transition-colors font-bold text-xl ${
                      isDark ? 'border-zinc-800 focus:border-[#CCFF00]' : 'border-zinc-100 focus:border-black'
                    }`}
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <textarea 
                    ...
                    className={`w-full bg-transparent border-b-2 py-4 outline-none transition-colors font-bold text-xl resize-none ${
                      isDark ? 'border-zinc-800 focus:border-[#CCFF00]' : 'border-zinc-100 focus:border-black'
                    }`}
                  />
                </div>
                ...
                <button 
                  ...
                  type="submit"
                  className={`w-full py-6 rounded-2xl font-black uppercase tracking-[0.2em] text-xs transition-all flex items-center justify-center gap-3 ${
                    isDark ? 'bg-white text-black hover:bg-[#CCFF00]' : 'bg-black text-white hover:bg-[#CCFF00] hover:text-black'
                  }`}
                >
