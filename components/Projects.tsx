...
const projects = [
  { id: 'neo-banking', title: 'NEO BANKING AI', category: 'Product / FinTech', img: 'https://images.unsplash.com/photo-1551288049-bbbda5366a7a?auto=format&fit=crop&w=800' },
  { id: 'crypto-dash', title: 'CRYPTO DASHBOARD', category: 'Engineering / Web3', img: 'https://images.unsplash.com/photo-1621761191319-c6fb62004040?auto=format&fit=crop&w=800' },
  { id: 'luxury-real', title: 'LUXURY REAL ESTATE', category: 'Creative / Experience', img: 'https://images.unsplash.com/photo-1512917774080-9991f1c4c750?auto=format&fit=crop&w=800' },
];
          ...
          {projects.map((project, index) => (
            ...
            >
              <div className="z-10 transition-transform duration-700 group-hover:translate-x-12">
                ...
                <h3 className={`text-5xl md:text-8xl font-black transition-colors duration-300 ${
                  isDark ? 'text-white group-hover:text-[#CCFF00]' : 'text-zinc-900 group-hover:text-[#CCFF00]'
                }`}>
                  {project.title}
                </h3>
              </div>
